    ...
    public static void main(String[] args) throws InterruptedException {
       ...
       // 3- Verify “remember me” label text is as expected:
        ...
        if (actualLabelText.equals(expectedLabelText)){
            ...
            System.out.println("Label text verification is FAIL!!!");
        }
       ...
       // Expected: Forgot your password?
        ...
        if (actualForgotPasswordText.equals(expectedForgotPasswordText)){
            ...
            System.out.println("Forgot password text verification is FAIL!!!");
        }
       ...
       // Expected: forgot_password=yes
        ...
        String actualValue = forgotPasswordLink.getAttribute("href");

        if (actualValue.contains(expectedInHref)){
